...
friendModule.get("/requests", auth.handle.bind(auth), controller.getFriendRequests.bind(controller));
friendModule.get("/:id/status", auth.handle.bind(auth), controller.getFriendStatus.bind(controller));
friendModule.get("/blocked", auth.handle.bind(auth), controller.getUserBlocks.bind(controller));

friendModule.post("/:id/invite", auth.handle.bind(auth), controller.getUserFriends.bind(controller));
friendModule.post("/:id/confirm", auth.handle.bind(auth), controller.friendConfirm.bind(controller));
