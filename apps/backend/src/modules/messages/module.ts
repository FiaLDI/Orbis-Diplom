...
export const messageModule = () => {
    ...
    router.get("/chats/:id/messages", auth.handle.bind(auth), controller.getPersonalMessages.bind(controller));
    router.post("/chats/:id/messages", auth.handle.bind(auth),controller.sendMessages.bind(controller));
