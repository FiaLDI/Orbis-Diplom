        ...
        >
                ...
                <div className="relative">
                    ...
                    <span
                        className={clsx(
                            ...
                            isBlocked ? "bg-gray-500" : isOnline ? "bg-green-400" : "bg-gray-600"
                        )}
                    />
                </div>
            ...
            {mode === "My Invite" && (
                <div className="flex gap-2">
                    ...
                    >
                        <CirclePlus className="w-15 h-15 lg:w-8 lg:h-8" strokeWidth="1.25" />
                    </button>
                    <button
                        className="cursor-pointer hover:text-red-400"
                        onClick={() => onReject?.(val.id)}
                    >
                        <CircleMinus className="w-15 h-15 lg:w-8 lg:h-8" strokeWidth="1.25" />
                    </button>
                </div>
            )}
        </li>
