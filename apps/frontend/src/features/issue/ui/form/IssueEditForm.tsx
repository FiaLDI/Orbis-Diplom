...
import { FormInput, FormTextArea, FormSelect, SubmitButton, FormError } from "@/shared/ui/Form";
...
export const IssueEditForm: React.FC<Props> = ({
    ...
    const { register, watch, setValue, formState } = useFormContext<IssueFormData>();
