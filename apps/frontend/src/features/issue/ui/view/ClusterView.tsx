...
export const ClusterView: React.FC<ClusterViewProps> = ({
    ...
    const center = focusedIssueId ? findIssueById(issues, focusedIssueId) : issues[0]; // fallback на первый root
        ...
        <div className="relative mx-auto my-6" style={{ width: SIZE, height: SIZE }}>
                ...
                {children.map((child: any, idx: number) => {
                    ...
                    return (
                        <line
                            ...
                            x2={x}
                            y2={y}
                            stroke={isActive ? "rgba(59,130,246,0.9)" : "rgba(148,163,184,0.5)"}
            ...
            >
                <div className="flex items-center gap-2">
                    ...
                    <span className="font-semibold max-w-[180px] truncate">{center.title}</span>
                </div>
              ...
              `}
                        ...
                        >
                            <div className="flex items-center gap-2 text-sm">
                                <span>{statusIcon[child.status?.name as Statuses] || "❓"}</span>
