...
import { leaveEditMode, updateMessageInHistory, useEditMessageMutation } from "@/features/messages";
...
export function useSingleMessageModel(message: any, currentUser?: any) {
    ...
    const handleCancel = () => {
        ...
        setAttachedFiles(message.content?.filter((c: { type: string }) => c.type !== "text") || []);
    };
