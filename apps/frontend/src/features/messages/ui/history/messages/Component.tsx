...
export const SingleMessage: React.FC<SingleMessageProps> = ({ message, onClick, currentUser }) => {
...
export const Component = React.memo(SingleMessage, (prev, next) => prev.message === next.message);
