                ...
                {open ? (
                    <div className="">
                                        ...
                                        <div className="flex gap-3 items-center justify-between">
                                            ...
                                            <div className="flex gap-2">
                                                <button
                                                    ...
                                                    title={
                                                        isSelf
                                                            ? t("audit.action.kick.titleyourself")
                                                            : t("audit.action.kick.title")
                                                    }
                                                ...
                                                <button
                                                    ...
                                                    title={
                                                        isSelf
                                                            ? t("audit.action.ban.titleyourself")
                                                            : t("audit.action.ban.title")
                                                    }
                                                ...
                                                <button
                                                    ...
                                                    title={
                                                        isSelf
                                                            ? t("audit.action.unban.titleyourself")
                                                            : t("audit.action.unban.title")
                                                    }
                        ...
                        <div className="p-5 flex flex-col gap-3">
                            ...
                            {isFetching && (
                                <div className="opacity-60">{t("audit.logs.loading")}</div>
                            )}
