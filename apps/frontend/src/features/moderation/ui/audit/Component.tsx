...
import { AuditLayout, MembersSection, LogsSection, BannedSection } from "@/features/moderation/ui";
import { useAuditModel } from "@/features/moderation/hooks";

export const Component: React.FC<{ activeserver: server }> = ({ activeserver }) => {
    const {
        reasonMap,
        setReasonMap,
        meId,
