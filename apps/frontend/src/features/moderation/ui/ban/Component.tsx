...
import { BanReasonLayout, BanReasonHead, BanReasonAction } from "@/features/moderation/ui";
import { useBanReasonModel } from "@/features/moderation/hooks";
            ...
            <BanReasonLayout
                ...
                controll={
                    <>
                        ...
                        <BanReasonAction handler={handleConfirm} title={t("audit.form.submit")} />
                    </>
                }
            />
        </ModalLayout>
