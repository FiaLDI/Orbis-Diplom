...
import { linksQueries } from "./queries/link";
...
export const serverApi = createApi({
  ...
  tagTypes: ["Servers", "ServerMembers", "Roles", "Links"],
  endpoints: (builder) => ({
