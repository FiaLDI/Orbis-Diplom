...
export const Component: React.FC = () => {
  ...
  return (
    <div className="p-5 bg-foreground/30 text-white rounded-lg">
      ...
      >
        <div>
          <label className="block mb-2">{t("menu.account.form.field.username.label")}</label>
          <input
            type="text"
        ...
        <div>
          <label className="block mb-2">{t("menu.account.form.field.password.label")}</label>
          <input
            type="password"
            {...register("password", {
              minLength: {
        ...
        <div>
          <label className="block mb-2">{t("menu.account.form.field.number.label")}</label>
          <input
            type="text"
            {...register("number", {
