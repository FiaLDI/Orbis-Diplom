                ...
                <div className="h-fit w-full flex flex-col gap-3 lg:max-w-7xl mx-auto lg:flex-row lg:justify-between ">
                    <div className="flex gap-5">
                        ...
                        <div className="">
                            ...
                            <p className="text-lg">Неважно где ты, важно с нами. <br />Мы здесь, чтобы стать ближе.</p>
                        </div>
                    </div>
                    <div className="flex gap-5">
                    ...
                    <div className="flex gap-5">
                        <div className="w-full">
                            <h2 className="text-4xl lg:text-lg">Навигация</h2>
                            <NavBar styleContainer="flex bg-transparent flex-row w-full justify-between lg:flex-col lg:text-lg lg:gap-0" styleList="cursor-pointer select-none !p-1"/>
                        </div>
                    </div>
                    <div className="flex gap-5">
                        <div className="w-full">
                            <h2 className="text-4xl lg:text-lg">Социальные сети</h2>
                    ...
                    <div className="flex gap-5">
                        <div className="w-full">
                            <h2 className="text-5xl lg:text-lg">Связь с нами</h2>
                            <div className="text-3xl lg:text-lg">
