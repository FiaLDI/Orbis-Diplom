    ...
    return (
        <div className="text-white py-50 text-center lg:py-10">
            <SectionLayout classListContainer="flex flex-col gap-5 lg:max-w-7xl lg:gap-2 lg:items-center">
                ...
                <p className="text-5xl my-10 lg:text-3xl">
                    Общайтесь и веселитесь вместе с ORBIS! На какой планете вы
                    бы{window.innerWidth > 1199 && <br />} ни были, друзья
                    всегда вас услышат!
                </p>
                ...
                <div className="flex flex-col gap-10 w-full justify-center items-center lg:flex-row ">
                    <ButtonHome buttonclass="lg:!py-2 lg:text-2xl lg:w-1/3">
                        Загрузить
                    </ButtonHome>
                    <ButtonHome buttonclass="lg:!py-2 lg:text-2xl lg:w-1/3">
                        Открыть в браузере
