...
export const Component: React.FC<Props> = ({ socket, notificationConnect, server }) => {
    const { avatarUrl, navigateToSettingsPage, setActiveServerHandler, setDisableServerHandler } =
    ...
    return (
        <MenuLayout
            ...
            MenuNotification={<NotificationArea notificationConnect={notificationConnect} />}
            SettingsMode={<SettingsButton navigateToSettingsPage={navigateToSettingsPage} />}
        />
    );
};
