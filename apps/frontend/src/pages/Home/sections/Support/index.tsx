    ...
    <div className="bg-[rgba(27,30,75,0.3)] " id="support">
      <SectionLayout classListContainer="gap-10 lg:max-w-7xl lg:flex-row">
        <div className="flex flex-col gap-5 w-full lg:p-5">
          ...
          <p className="text-lg ">
            Здесь вы можете обратиться за помощью по любому интересующему вас
            вопросу — будь то настройка сервера, проблемы с аккаунтом или просто
            совет по использованию платформы. Наша команда и сообщество всегда
